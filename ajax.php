...
{	
	case 'addregistration':
        ...
        if (isset($allUsers)){
            ...
            foreach ($roleArray as $thisRole){
                $wp_user_search = new WP_User_Search("", "", (string)$thisRole);
                $userIds = array_merge($userIds,$wp_user_search->get_results());
            }
        }
    ...
    case "addAnonRegGetLaunchUrl":
        ...
        if (count($inviteRegs) > 0) {
            ...
            $regService->CreateRegistration($regid, $courseId, $user_email, $user_first_name, $user_last_name);
    ...
    case "addUserRegGetLaunchUrl":
        ...
        $roleArray = array('subscriber','contributor','author','editor','editor','editor','editor','editor','administrator','administrator','administrator');
        $learnerTags = $roleArray[(int)$current_user->user_level];
    ...
    case "getPropertiesEditorUrl":
        ...
        $cssurl = get_option( 'siteurl' )."/wp-content/plugins/wp-e-commerce-scormcloud/css/scormcloud.ppeditor.css";
