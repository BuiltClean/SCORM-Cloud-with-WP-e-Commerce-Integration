...
if($success=='true')
{
    echo '<span class="importMessage">'.__("Processing Import....").'</span>';
    ...
    echo '<span class="importMessage">'.__("There was an error uploading your package. Please try again.").'</span>';
